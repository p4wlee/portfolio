  ...
  return (
    <section id="about" ref={ref} className="section about reveal-slide-left">
      ...
      <p>
        ...
        un'applicazione, quello che l'utente non vede ma che fa funzionare tutto. Mi piace ragionare sulla logica dietro a un progetto, su come sono organizzati i dati, su come si progettano le API e
        i database, e tengo molto a scrivere codice ordinato e mantenibile.
      </p>
      <p>
        ...
        importante. Ho imparato a organizzare il lavoro, a gestire processi e persone, a prendermi le mie responsabilità. Sono competenze che oggi mi porto dietro anche nello sviluppo. Non è stato il
        percorso più semplice, ma per me era quello giusto.
      </p>
